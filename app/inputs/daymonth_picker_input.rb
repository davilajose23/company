# DaymonthPickerInput render for simple form datepickers
class DaymonthPickerInput < SimpleForm::Inputs::StringInput
  ...
  def display_pattern
    I18n.t('datepicker.dformat', default: '%d %b')
  end

  def picker_pettern
    I18n.t('datepicker.pformat', default: 'DD MMM')
  end
end
